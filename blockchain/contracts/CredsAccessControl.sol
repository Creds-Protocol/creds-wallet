...
import "./CredsProtocolOpenIssuer.sol";
...
contract CredsProtocolAccessControl is IEncryptionClient, PullPayment {
    /// @notice The Encryption Oracle Instance
    IEncryptionOracle public oracle;
    CredsProtocolOpenIssuer public issuer;
    ...
    constructor(IEncryptionOracle _oracle, address _issuer) {
        oracle = _oracle;
        issuer = CredsProtocolOpenIssuer(_issuer);
    }
    ...
    function createListing(
        ...
        emit NewListing(msg.sender, cipherId, name, description, 0, uri);
        return cipherId;
    }
    ...
    function buyListing(
        ...
        issuer.verifyCred(credId, merkleTreeRoot, signal, nullifierHash, externalNullifier, proof);
